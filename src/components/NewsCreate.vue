<template>
  <div class="max-w-3xl mx-auto">
    ...
    <div class="bg-gray-800/50 backdrop-blur-lg rounded-xl border border-gray-700 p-8">
      <div class="mb-6">
        <h1 class="text-3xl font-bold text-white mb-2">Create News Article</h1>
        <p class="text-gray-400">Share your story with the community</p>
      </div>
  ...
  methods: {
    async createNews() {
      ...
      try {
        ...
        this.errorMessage = error.message || 'Failed to create article';
      } finally {
